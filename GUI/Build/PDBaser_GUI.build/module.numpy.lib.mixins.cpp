...
static PyObject *impl_numpy$lib$mixins$$$function__2__binary_method(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Framed code:
    {
        ...
        tmp_assattr_value_1 = CALL_METHOD_WITH_SINGLE_ARG(tmp_called_instance_1, mod_consts[5], tmp_args_element_name_1);
...
static PyObject *impl_numpy$lib$mixins$$$function__4__inplace_binary_method$$$function__1_func(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Framed code:
    {
        ...
        frame_baeec603883c05ec352ef5ca45aa62eb->m_frame.f_lineno = 39;
        {
            ...
            tmp_return_value = CALL_FUNCTION_WITH_ARGS2_KWSPLIT(tmp_called_name_1, args, kw_values, mod_consts[16]);
        }
